...
namespace AracTakipSistemi.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(AppIdentityDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ID,Type,Id,Name,NormalizedName,ConcurrencyStamp")] Roles roles)
        {
            if (id != roles.Id)
            {
                return NotFound();
